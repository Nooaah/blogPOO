...
if (isset($_POST['sendPost']))
{
    if (!empty($_POST['title']))
    {
        if (!empty($_POST['content']))
        {
            ...
            $postUpdate->setCategorie($categorie);
            $postUpdate->setID($getid);

            $pt->update($postUpdate);
...
?>
            <h1 class="mt-5">Modifier l'article <?= $post->getTitle() ?></h1>

            <div class="row">
                <div class="col-md-8">
                    <!-- Material input -->
                    <div class="md-form">
                    <input type="text" id="form1" name="title" class="form-control" value="<?= $post->getTitle() ?>">
            ...
            <div class="md-form">
                ...
                $text = str_replace("<br />", "", $post->getContent());
